    ...
    <>
        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 lg:py-24">
          <div className="grid items-center gap-10 lg:grid-cols-12">
            ...
            <div className="text-white lg:col-span-7">
              <div className="inline-flex items-center gap-2 rounded-full border border-amber-400/60 bg-stone-900/80 px-4 py-1.5 text-xs font-semibold text-amber-200 backdrop-blur-md shadow-lg shadow-amber-950/30 animate-float-slow">
              ...
              <p className="mt-5 max-w-xl text-base text-stone-200/95 sm:text-lg leading-relaxed font-normal drop-shadow-sm">
                Trusted by families. Chosen by hearts. YFJ Matrimony brings together verified brides
                and grooms with complete privacy, respect, and family involvement.
              </p>
            ...
            <div className="lg:col-span-5">
              <div className="rounded-3xl border-2 border-amber-400/50 bg-card/95 p-6 sm:p-7 shadow-2xl shadow-black/40 backdrop-blur-xl dark:bg-stone-900/95 gold-glow transition-all duration-300 hover:border-amber-400/70">
                ...
                <form onSubmit={handleSearch} className="mt-5 space-y-4">
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="w-full h-12 rounded-xl bg-gradient-to-r from-primary via-rose-600 to-amber-600 hover:opacity-95 text-white font-semibold shadow-lg shadow-rose-950/30 mt-2 transition-all active:scale-[0.99] cursor-pointer"
                  >
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {pillars.map(({ icon: Icon, title, body }) => (
            <article
              key={title}
              className="rounded-3xl border border-amber-400/30 bg-card p-5 shadow-card hover:border-amber-400/70 hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 group"
            >
              <span className="grid size-11 place-items-center rounded-full bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-400/30 group-hover:scale-110 transition-transform">
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        ...
        <ol className="mt-8 grid gap-4 md:grid-cols-3">
          {steps.map((step, index) => (
            <li
              key={step.title}
              className="rounded-3xl border border-amber-400/30 bg-card p-6 shadow-card hover:border-amber-400/70 hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300"
            >
              <span className="font-display text-4xl font-bold bg-gradient-to-r from-amber-500 to-amber-300 bg-clip-text text-transparent">
                0{index + 1}
              </span>
      ...
      <section className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6">
        ...
        <p className="mx-auto mt-3 max-w-xl text-sm text-muted-foreground">
          Create your profile in a few minutes and start receiving matches that respect your values.
        </p>

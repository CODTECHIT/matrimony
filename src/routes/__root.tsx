...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "YFJ Matrimony — Trusted matchmaking for families" },
      {
        name: "description",
        content:
          "YFJ Matrimony connects verified brides and grooms with privacy, respect and family involvement at every step.",
      },
